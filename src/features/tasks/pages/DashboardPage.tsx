      ...
      <div className="relative">
        ...
        >
          <div>
            ...
            <p className="mt-2 text-gray-400">Monitor and manage your scheduled tasks</p>
          </div>

          <button
            onClick={() => setShowTaskForm(true)}
            className="flex items-center space-x-2 bg-gradient-to-r from-primary to-purple-500 text-white px-6 py-3 rounded-lg hover:opacity-90 transition-opacity"
          >
    ...
    >
      ...
      <div className="relative p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent flex items-center gap-2">
        ...
        <div className="space-y-4">
          {tasks.map(task => (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="relative overflow-hidden p-4 backdrop-blur-sm bg-black/20 rounded-lg border border-white/5"
            >
              <div className="flex items-center justify-between">
                <div>
